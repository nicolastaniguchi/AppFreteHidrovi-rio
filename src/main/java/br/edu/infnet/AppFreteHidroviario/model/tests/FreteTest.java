...
public class FreteTest {
	public static void main(String[] args) {
		...
		BalsaCarreteira bc3 = new BalsaCarreteira("Yamato03", 3000, 20, 5, 1, 40, true);
		...
		List<Embarcacoes> embarcacoesE1 = new ArrayList<Embarcacoes>();
		embarcacoesE1.add(bc1);
		List<Embarcacoes> embarcacoesE2 = new ArrayList<Embarcacoes>();
		embarcacoesE2.add(bc2);
		embarcacoesE2.add(bc3);
		List<Embarcacoes> embarcacoesE3 = new ArrayList<Embarcacoes>();		
