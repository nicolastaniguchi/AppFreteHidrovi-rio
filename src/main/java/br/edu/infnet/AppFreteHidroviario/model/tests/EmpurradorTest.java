...
public class EmpurradorTest {
	public static void main(String[] args) {
		...
		Empurrador e1 = new Empurrador(1, "Yamato", 1000, 30, 10, 2);
		e1.setMotor(1);
		e1.setRancho(false);
		...
		Empurrador e2 = new Empurrador(2, "Yamato02", 2000, 30, 10, 2);
		e2.setMotor(2);
		e2.setRancho(true);
		...
		Empurrador e3 = new Empurrador(3, "Yamato03", 3000, 30, 10, 2);
		e3.setMotor(4);
		e3.setRancho(true);
